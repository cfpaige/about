...
### Practice
* [CSS Diner: Attribute Selector Game](http://flukeout.github.io/)
* [JS Code Sandbox: Eloquent JavaScript Exercises](https://eloquentjavascript.net/code/)
* [Code Arcade: Technical Interview Practice](https://app.codesignal.com/arcade)
